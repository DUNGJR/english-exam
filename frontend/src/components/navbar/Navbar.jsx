...
import { Input, Avatar, Button, Dropdown, Menu, Row, Col } from 'antd';
    ...
    <div className="navbar">
      ...
      <div className="navbar_responsive">
        <div className="navbar-links">
          <div className="navbar-links_container" style={{ fontWeight: '500', }}>
          ...
          <Search className='search-input' placeholder="Tìm đề thi" enterButton style={{ width: "60%", padding: 30 }} />
